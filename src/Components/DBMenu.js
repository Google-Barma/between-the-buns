const dbMenu = {
  ...
  other: [
    ...
    {
      name: 'MultiPage Set',
      img: '/menu/multi-page-combo.png',
      id: 10,
      price: 200,
      choices: ['Свинина', 'Говядина'],
    },
    {
      name: 'Webpack Set',
      img: '/menu/webpack-combo.png',
      id: 11,
      price: 250,
      choices: ['Майонез', 'Барбекю'],
    },
    {
      name: 'SinglePage Set',
      img: '/menu/single-page-combo.png',
      id: 12,
      price: 375.25,
